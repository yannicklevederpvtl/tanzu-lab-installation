...
variable "tkgi_deployment_cidr" {
  description = "CIDR for the tkgi deployment segment"
  type        = string
  default     = "192.168.7.0/24"
}

variable "tkgi_nsxt_ingress_cidr" {
  description = "CIDR for the NSX-T ingress network"
  type        = string
}

variable "tkgi_nsxt_egress_cidr" {
  description = "CIDR for the NSX-T egress network"
  type        = string
}

variable "tkgi_deployment_nat_gateway_ip" {
  description = "The source IP address to use for all traffic leaving the tkgi deployment network"
  type        = string
}

variable "tkgi_lb_api_virtual_server_ip_address" {
    description = "The IP address on which the api virtual server listens for traffic"
    type        = string
}